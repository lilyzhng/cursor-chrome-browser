// Content script for the Cursor Chrome Browser extension.
...
//
// Borrowed verbatim from the open-claude-in-chrome reference (MIT); only the
// internal global name was rebranded.

(function () {
  if (window.__cursorChromeBrowserLoaded) return;
  window.__cursorChromeBrowserLoaded = true;
